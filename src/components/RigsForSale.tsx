      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        <div className="mb-12">
          ...
          <p className="text-center text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
            Whether by land or by sea the Mobile Dwellings Marketplace is a space for full time homes that you can take with you. Finished rigs for your window shopping pleasure or reach out to a seller directly to buy one!
          </p>
        </div>
