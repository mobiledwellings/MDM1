      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-6 text-center">
            Mobile Dwellings is a documentary video series exploring the diverse world of alternative living. 
          ...
          <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed md:text-left text-center">
            ...
            alternative lifestyles, Mobile Dwellings is here to inspire, inform, and connect you with a community.
          </p>
        </div>
      </div>
    </section>
