          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Use coupon code MOBILE50 at signaturesolar.com for an exclusive discount on EG4 inverters, lithium batteries, solar panels, and more. This Signature Solar promo code is provided through our partnership and works on most products sitewide."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. Signature Solar partners with creators and builders in the skoolie and overland community. Mobile Dwellings has an exclusive Signature Solar coupon code: MOBILE50. Enter it at checkout on signaturesolar.com to save."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "For most skoolie builds, a 3000W pure sine wave inverter is ideal. The EG4 6000XP from Signature Solar is one of the most popular choices in the skoolie community. Use code MOBILE50 at signaturesolar.com to save."
              }
            },
            {
              "@type": "Question",
              ...
              <div className="mb-12">
                ...
                <div className="max-w-2xl mx-auto mb-12 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg p-6 text-center">
                  ...
                  <div className="inline-flex items-center gap-3 bg-neutral-50 dark:bg-neutral-800 border-2 border-dashed border-green-500 rounded-lg px-6 py-3">
                    ...
                    <span className="font-mono font-bold text-xl text-green-600 dark:text-green-400 tracking-wider">MOBILE50</span>
                  </div>
