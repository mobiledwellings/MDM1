...
import { SIGNATURE_SOLAR_LAST_VERIFIED } from "../data/coupon-verification";
  ...
  return (
    <>
      <SEO
        ...
        description={`Use coupon code ${COUPON_CODE} at Signature Solar for $50 off. Checked every few days and verified active on ${SIGNATURE_SOLAR_LAST_VERIFIED} by Justin Smith of Mobile Dwellings, who runs EG4 gear in a 40-foot skoolie. Works on EG4 batteries, inverters, solar panels and more at signaturesolar.com.`}
